<template>
  <!--
    ...
    MainSurface.vue (`<CardsLoadError v-if/> <StageDeck v-else/>` under
    Stage), so StageDeck is not mounted while erroring at idle.
  -->
 ...
 */
import { useCardsLoadError } from '../../../flows/base/composables/use_cards_load_error'
